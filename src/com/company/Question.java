...
public class Question {
    ...
    void load() throws FileNotFoundException //this void reads data from a file FileNot... wyjatek
    {
        ...
        int line_number = (number_question - 1) * 6 + 1; //nr statrotwy lini od ktorej bedzimey czytac
    ...
    {
        Scanner scan = new Scanner(System.in); //mozliwosc wprwoadzenia danych klasa Scanner
        System.out.println();                           //robi odstęp od góry od wyświetlanej tresci
        System.out.println("Pytanie: " + contents);
        System.out.println("a) " + a);
        System.out.println("b) " + b);
        System.out.println("c) " + c);
        System.out.println("d) " + d);
        System.out.println();                           //robi odstęp odpowiedzi od mozliwych opcji wyobru
